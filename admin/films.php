...
printf("\n <div class=\"alert alert-success\" role=\"alert\"><h3>
        Film inserito correttamente. </h3></div> ");
    }
    else {
...
<form class="d-flex" action="films.php" method="post">
  <input type="search" id="idfilm" placeholder="Inserisci ID (IMDB) del film" class="form-control me-2" aria-label="Search" name="idfilm"><br>
  <input type="submit" class="btn btn-outline-success" name="submit" value="Cerca">
...
$('#members').DataTable( { "ajax": 'filmsdata.php'    
    });
});
</script>
